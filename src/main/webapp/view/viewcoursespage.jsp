...
<div class="container">
    <div class="text-center">
        <h1 class="display-4">Core Java Student Courses Table Record</h1>
    ...
    <form action="save" method="post" class="row">
        ...
        <div class="form-group col-md-12 btn-container">
            ...
            <button type="submit" formaction="update" class="btn btn-warning btn-custom">Update</button>
            <button type="submit" formaction="delete" class="btn btn-danger btn-custom">Delete</button>
