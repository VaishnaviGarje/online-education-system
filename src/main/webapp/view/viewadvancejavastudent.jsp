...
<div class="container">
    <div class="text-center">
        <h1 class="display-4">Advance Java Student Courses</h1>
       
    </div>
    <br>

    <form action="Advancejava" method="post" class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="fname" name="lname" placeholder="Enter first name">
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-12 btn-container">
            ...
            <button type="submit" formaction="updateadvancejava" class="btn btn-warning btn-custom">Update</button>
            <button type="submit" formaction="deleteAdvancejava" class="btn btn-danger btn-custom">Delete</button>
