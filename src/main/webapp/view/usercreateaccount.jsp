...
#bg {
  background-image: url('img/MAINICON1.jpg');
  position: fixed;
  left: 0;
  top: 0;
  width: 100%;
...
<marquee>
			<font face="Bold" size=60><h1>
					<font color=black style="pause-after: 3s;"> Vaishnavi Online Education System</font>
		</marquee>
...
<form action="usercreateaccount" method="post">
