...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">
        <h1>
					<img src="img/MAINICON1.jpg" width="80" height="100"> The<font
...
<div class="container">
    <div class="text-center">
        <h1 class="display-4">SalesForce Student Courses Table Record</h1>

    </div>
    <br>

    <form action="viewSalesforcestudent" method="post" class="row">
        ...
        <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="fname" name="lname" placeholder="Enter Last name">
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-12 btn-container">
            ...
            <button type="submit" formaction="updateSalesforcestudent" class="btn btn-warning btn-custom">Update</button>
            <button type="submit" formaction="deleteSalesforcestudent" class="btn btn-danger btn-custom">Delete</button>
