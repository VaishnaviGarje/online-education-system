...
<div class="container">
    <div class="text-center">
        <h1 class="display-4">Selenium Student Courses Table Record</h1>
    </div>
    <br>

    <form action="viewseleniumstudent" method="post" class="row">
        ...
        <div class="form-group col-md-12 btn-container">
            ...
            <button type="submit" formaction="updateseleniumstudent" class="btn btn-warning btn-custom">Update</button>
            <button type="submit" formaction="deleteseleniumstudent" class="btn btn-danger btn-custom">Delete</button>
